...
class Media
{
    static public function uploadImageMulti($data)
    {
        ...
        $newFileName = md5($date . $microtime) . '.' . $extension;

        // $dir = "garduweb/storage/upload/images";
        $dir            = PROJECT . "/storage/upload/images";
        $dir_thumb      = $dir . "/thumb";
        $dir_icon       = $dir . "/icon";
    ...
    {
        if (!empty($data)) :
            unlink(PROJECT . '/storage/upload/images/' . $data);
            unlink(PROJECT . '/storage/upload/images/thumb/' . $data);
            unlink(PROJECT . '/storage/upload/images/icon/' . $data);
            return 1;
        else :
            return 0;
        endif;
