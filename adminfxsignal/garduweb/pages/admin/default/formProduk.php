                ...
                <div class="card-upload">
                    <div class='preview'>
                        <?php if (@$data->img1 != NULL) { ?>
                            <img src="/<?= STORAGE ?>/upload/images/thumb/<?= @$data->img1 ?>" id="img1" width="100" height="100">
                        <?php } else { ?>
                            <img src="/<?= STORAGE ?>/images/plus.jpg" id="img1" width="100" height="100">
                        <?php } ?>
                    </div>
                    <div>
                ...
                <div class="card-upload">
                    <div class='preview'>
                        <?php if (@$data->img2 != NULL) { ?>
                            <img src="/<?= STORAGE ?>/upload/images/thumb/<?= @$data->img2 ?>" id="img2" width="100" height="100">
                        <?php } else { ?>
                            <img src="/<?= STORAGE ?>/images/plus.jpg" id="img2" width="100" height="100">
                        <?php } ?>
                    </div>
                    <div>
                ...
                <div class="card-upload">
                    <div class='preview'>
                        <?php if (@$data->img3 != NULL) { ?>
                            <img src="/<?= STORAGE ?>/upload/images/thumb/<?= @$data->img3 ?>" id="img3" width="100" height="100">
                        <?php } else { ?>
                            <img src="/<?= STORAGE ?>/images/plus.jpg" id="img3" width="100" height="100">
                        <?php } ?>
                ...
                <div class="card-upload">
                    <div class='preview'>
                        <?php if (@$data->img4 != NULL) { ?>
                            <img src="/<?= STORAGE ?>/upload/images/thumb/<?= @$data->img4 ?>" id="img4" width="100" height="100">
                        <?php } else { ?>
                            <img src="/<?= STORAGE ?>/images/plus.jpg" id="img4" width="100" height="100">
                        <?php } ?>
                ...
                <div class="card-upload">
                    <div class='preview'>
                        <?php if (@$data->img5 != NULL) { ?>
                            <img src="/<?= STORAGE ?>/upload/images/thumb/<?= @$data->img5 ?>" id="img5" width="100" height="100">
                        <?php } else { ?>
                            <img src="/<?= STORAGE ?>/images/plus.jpg" id="img5" width="100" height="100">
                        <?php } ?>
